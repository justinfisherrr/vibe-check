...
function verifyAtLeastOneMatch(fullWeightedArr) {
...
function compareArtists(topItemInstance) {
	...
	const user2Strata = createStrata(user1Arr.length);
...
function getTopArtists(user1, user2, type) {
